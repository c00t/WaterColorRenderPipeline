...
namespace UnityEngine.Experimental.Rendering.LWRP
{
    ...
    internal class RenderOpaqueForwardPass : ScriptableRenderPass
    {
        ...
        {
            RegisterShaderPassName("LightweightForward");//知道了，这里register的是shader 文件里light mode里对应的tag name
        ...
        public override void Execute(ScriptableRenderer renderer, ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingSample(cmd, k_RenderOpaquesTag))
            {
                ...
                SetRenderTarget(cmd, outBuffers, depthAttachmentHandle.Identifier(), clearFlag, clearColor);
