Shader "Hidden/Water Color PostProcess/QuadBlend"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.lightweight/Shaders/QuadBlend.hlsl"
