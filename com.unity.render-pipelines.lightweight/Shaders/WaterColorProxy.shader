...
Shader "Lightweight Render Pipeline/Water Color Proxy"
{
...

    {
        ...
        _Feathering("Feathering",Range(0.0,1.0)) = 0.0
        ...
        [ToogleOff] _ReceiveShadows("Receive Shadows", Float) = 0
        [Toggle(_COOKIE_TEX)] _COOKIE_TEX("Use Alpha Texture", Int) = 0
        [Toggle(_ALPHATEST_ON)] _ALPHATEST_ON("Alpha Test", Int) = 1
    ...
    SubShader
    {
        Tags { "RenderType" = "Transparent" "Queue" = "Transparent-150" "RenderPipeline" = "LightweightPipeline" "IgnoreProjector" = "True"}//Opaque
        LOD 300
        Pass
        {
            Name "ForwardLit"
            Tags { "LightMode" = "WaterColorProxyForward" }

            // Use same blending / depth states as Standard shader
            Blend One OneMinusSrcAlpha//[_SrcBlend][_DstBlend]
            ZWrite Off
            Cull[_Cull]
            ...
            // -------------------------------------
            // Material Keywords
            #pragma shader_feature _COOKIE_TEX
            ...
            half _Feathering;
            #include "WaterColorProxyForwardPass.hlsl"
            ENDHLSL
        }
